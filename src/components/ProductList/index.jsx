...
const ProductList = () => {
  const dailyDeals = [
    {
      id: 1,
      name: 'Hộp 3 Miếng Mặt Nạ Dưỡng Ẩm',
    ...
    {
      id: 2,
      name: 'Hộp 3 Miếng Mặt Nạ Thải Độc',
    ...
    {
      id: 6,
      name: 'Eyeliner Tạo Nét Mịn Màng',
  ...
  const productsForYou = [
    {
      id: 1,
      name: 'Combo Mặt Nạ Dưỡng Da Iconic',
    ...
    {
      id: 2,
      name: 'Mặt Nạ Gạo Cao Cấp - Mua 2 Tặng 1',
